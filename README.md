...
4. Keep the active dated report and run-log JSONL named in the target repo `AGENTS.md` while backfill is in progress.
...
8. Use `skills/evaluate-backfill-specs/SKILL.md` to score slices and the completed graph, revise weak categories, and mark only strict 96+ results acceptable.
