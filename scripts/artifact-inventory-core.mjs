...
function currentRunArtifactPaths(runId) {
  return new Set([
    ...
    `docs/specs/backfill/surface-function-map-${runId}.jsonl`,
    `docs/specs/backfill/surface-function-map-check-${runId}.json`,
    `docs/specs/backfill/surface-function-map-eval-${runId}.jsonl`,
    `docs/specs/backfill/surface-function-map-summary-${runId}.html`,
    `docs/specs/backfill/surface-function-map-refresh-${runId}.json`,
    `docs/specs/backfill/capability-map-${runId}.jsonl`,
    `docs/specs/backfill/capability-map-check-${runId}.json`,
    `docs/specs/backfill/capability-map-eval-${runId}.jsonl`,
    `docs/specs/backfill/capability-map-summary-${runId}.html`,
    `docs/specs/backfill/capability-map-refresh-${runId}.json`,
    `docs/specs/backfill/spec-job-queue-${runId}.jsonl`,
    `docs/specs/backfill/spec-job-queue-check-${runId}.json`,
    `docs/specs/backfill/spec-job-queue-eval-${runId}.jsonl`,
    `docs/specs/backfill/spec-job-queue-summary-${runId}.html`,
    `docs/specs/backfill/spec-job-queue-refresh-${runId}.json`,
    `docs/specs/backfill/context-pack-${runId}.jsonl`,
    `docs/specs/backfill/context-pack-check-${runId}.json`,
    `docs/specs/backfill/context-pack-eval-${runId}.jsonl`,
    `docs/specs/backfill/context-pack-summary-${runId}.html`,
    `docs/specs/backfill/context-pack-refresh-${runId}.json`,
    `docs/specs/backfill/process-action-map-${runId}.jsonl`,
    `docs/specs/backfill/process-action-map-check-${runId}.json`,
    `docs/specs/backfill/process-action-map-eval-${runId}.jsonl`,
    `docs/specs/backfill/process-action-map-summary-${runId}.html`,
    `docs/specs/backfill/process-action-map-refresh-${runId}.json`,
    `docs/specs/backfill/author-specs-${runId}.jsonl`,
    `docs/specs/backfill/author-specs-check-${runId}.json`,
    `docs/specs/backfill/author-specs-eval-${runId}.jsonl`,
    `docs/specs/backfill/author-specs-summary-${runId}.html`,
    `docs/specs/backfill/author-specs-refresh-${runId}.json`,
