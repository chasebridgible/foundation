...
Creates or updates a target backfill report with Capability Map V1 handoff state and embedded backfill-capability-matrix JSON.`;
}
...
function main() {
  ...
  appendRunLogEvent(runLogPath, {
    ...
    checks: [{ name: "capability-matrix-handoff", result: state.nextLayer === "Define Spec Jobs" ? "passed" : "needs-revision" }],
