...
description: Map concrete actor processes, actions, states, decisions, and recovery paths from a Context Pack during a Foundation spec backfill. Use inside Backfill Specs for user-facing, operator-facing, admin, external-system, or scheduled-system capability slices before Author Specs. This is the legacy skill name for the Process / Action Map layer.
---
