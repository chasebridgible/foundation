...
- Use the Surface Registry Fill Loop skill at `skills/surface-registry-fill-loop/SKILL.md` when creating, filling, refreshing, checking, evaluating, or revising a target repo surface registry.
